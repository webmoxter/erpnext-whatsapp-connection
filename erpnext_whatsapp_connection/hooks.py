...
app_title = "ERPNext WhatsApp Connection by ERPFin360.com"
app_publisher = "ERPFin360.com"
app_description = "Permission-checked WhatsApp document delivery for Frappe and ERPNext"
app_email = "support@erpfin360.com"
app_license = "GPL-3.0"
frappe_version = ">=16.0.0 <17.0.0"
required_apps = ["erpnext"]

app_include_js = "/assets/erpnext_whatsapp_connection/js/send_by_whatsapp.js?v=0.1.0"
